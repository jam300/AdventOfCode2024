...
int main() {
    ...
    ReadDataFromFile("C:\\Users\\JMendez\\Documents\\AdventCode\\Day5\\Input_Data.txt", rules, updates);
    ...
    std::cout << middle_page_sum << std::endl; 
    ...
    std::cout << std::endl << middle_page_sum_broken << std::endl; 
